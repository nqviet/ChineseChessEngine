...
enum Value : int
{
	...
	CanonValueMg = 1285, CanonValueEg = 1371,
...
enum PieceType
{
	NO_PIECE_TYPE, SOLDIER, HORSE, ELEPHANT, CANON, CHARIOT, ADVISOR, GENERAL,
	ALL_PIECES = 0,
	PIECE_TYPE_NB = 9
};
...
{
	NO_PIECE,
	W_SOLDIER = 1, W_HORSE, W_ELEPHANT, W_CANON, W_CHARIOT, W_ADVISOR, W_GENERAL,
	B_SOLDIER = 9, B_HORSE, B_ELEPHANT, B_CANON, B_CHARIOT, B_ADVISOR, B_GENERAL,
	PIECE_NB = 16
};

const Piece Pieces[] =
{
	W_SOLDIER, W_HORSE, W_ELEPHANT, W_CANON, W_CHARIOT, W_ADVISOR, W_GENERAL,
	B_SOLDIER, B_HORSE, B_ELEPHANT, B_CANON, B_CHARIOT, B_ADVISOR, B_GENERAL
};
